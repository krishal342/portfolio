      ...
      <ul className='flex flex-wrap gap-2'>
        {
          prop.items.map((item, index) => (
            <li key={index} className='px-4 py-1 bg-blue-500/15 w-fit text-sm lg:text-base rounded-full'>{item}</li>
          ))
        }
      </ul>
    </div>
...
//         {
//           prop.items.map((item, index) => (
//             <li key={index} className='px-4 py-1 bg-blue-500/15 w-fit text-sm lg:text-base rounded-full list-disc list-inside'>{item}</li>
//           ))
//         }
//       </ul>
//     </div>
