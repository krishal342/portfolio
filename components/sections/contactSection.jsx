...
const ContactSection = () => {
    return (
        <div className='h-full w-full flex flex-col  gap-10 p-5 py-10 max-w-[1440px] mx-auto '>
            <h1 className='heading-one border-l-8 py-2 pl-4 border-blue-500'>Contact</h1>
